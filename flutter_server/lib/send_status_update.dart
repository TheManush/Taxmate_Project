              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(Icons.account_balance, color: Colors.deepPurple[800], size: 24),
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(Icons.assignment_turned_in, color: Colors.deepPurple[800], size: 24),
                        const SizedBox(width: 10),
                        Text(
                          'Select Status',
                          style: TextStyle(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(Icons.note_add, color: Colors.deepPurple[800], size: 24),
                        const SizedBox(width: 10),
                        Text(
                          'Add Note',
                          style: TextStyle(
