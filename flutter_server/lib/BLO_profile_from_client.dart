      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.request_page, color: Colors.deepPurple[700], size: 24),
                const SizedBox(width: 10),
                Text(
                  'Service Request',
                  style: TextStyle(
            ...
            FutureBuilder<Map<String, dynamic>?>(
              future: apiService.checkExistingRequest(clientId, null, bloData['id'], null),
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(Icons.upload_file, color: Colors.deepPurple[700], size: 24),
                        const SizedBox(width: 10),
                        Text(
                          'Upload Documents',
                          style: TextStyle(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(Icons.account_balance, color: Colors.deepPurple[700], size: 24),
                        const SizedBox(width: 10),
                        Text(
                          'Loan Request Form',
                          style: TextStyle(
